package dw.trabalho.futebol.security;
...
public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeHttpRequests(authorize -> authorize
            .requestMatchers("/auth/login", "/auth/register", "/auth/adm/login").permitAll()
            .requestMatchers("/jogador/all").hasAnyRole("ADM")
            .requestMatchers("/pagamento/all").hasRole("ADM")
            .requestMatchers("/jogador/create").permitAll()
            .requestMatchers("/jogador/**").hasAnyRole("JOGADOR", "ADM")
